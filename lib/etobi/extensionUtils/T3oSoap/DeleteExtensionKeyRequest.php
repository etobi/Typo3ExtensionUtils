...
class DeleteExtensionKeyRequest extends AbstractAuthenticatedRequest {
    ...
    public function deleteExtensionKey($extensionKey)
    {
        ...
        if($result['resultCode'] == self::TX_TER_RESULT_GENERAL_OK){
	        ...
	        throw new \etobi\extensionUtils\T3oSoap\Exception\ExtensionKeyHasUploadsException(sprintf(
            ...
            throw new \etobi\extensionUtils\T3oSoap\Exception\ExtensionKeyNotExistsException(sprintf(
